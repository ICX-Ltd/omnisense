export const ApiPath = {
  ...
  SurveyCompetitorAnalysis: "/uiapi/survey/competitor-analysis",
  SurveyQuarterlyTrends: "/uiapi/survey/quarterly-trends",
  SurveyMonthlyTrends: "/uiapi/survey/monthly-trends",
